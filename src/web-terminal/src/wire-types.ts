...
export interface FrameImage extends ImageMetadata { bytes: Uint8Array<ArrayBuffer> }
...
export type CellPosition = { x: number; y: number } & Partial<Pick<InputModifiers, "ctrl" | "alt" | "shift">>;
