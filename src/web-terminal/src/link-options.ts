...
export function validateLinkAction(action: unknown, actions: ReadonlySet<string>): asserts action is TerminalLinkAction {
...
export function normalizeLinks(options: false | TerminalLinkOptions | undefined,
  actions: ReadonlySet<string>): false | TerminalLinkOptions {
...
export function linkAction(handler: (context: TerminalInputContext, link: TerminalLinkActivation,
  input: Readonly<TerminalInput> | undefined) => unknown): InputActionHandler {
