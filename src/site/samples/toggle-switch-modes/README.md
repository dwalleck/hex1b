...
Extracted from `src/content/guide/widgets/toggle-switch.md`, binding `modesSnippet`.
Imported source: `src/content/guide/widgets/snippets/toggle-switch-modes.cs`.
