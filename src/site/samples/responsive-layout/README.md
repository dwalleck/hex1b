...
Extracted from `src/content/guide/widgets/responsive.md`, binding `layoutSnippet`.
Imported source: `src/content/guide/widgets/snippets/responsive-layout.cs`.
