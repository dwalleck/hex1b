...
Extracted from `src/content/guide/widgets/toggle-switch.md`, binding `focusSnippet`.
Imported source: `src/content/guide/widgets/snippets/toggle-switch-focus.cs`.
