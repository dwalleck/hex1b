...
Extracted from `src/content/guide/widgets/responsive.md`, binding `customSnippet`.
Imported source: `src/content/guide/widgets/snippets/responsive-custom.cs`.
