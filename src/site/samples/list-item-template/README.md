...
Extracted from `src/content/guide/widgets/list.md`, binding `templateCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...). Renamed TypedList to the generic List API in Hex1b 0.166.0.
