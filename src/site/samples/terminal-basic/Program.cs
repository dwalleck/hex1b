...
await new TerminalBasicExample().RunAsync(CancellationToken.None);
...
/// </remarks>
internal class TerminalBasicExample
{

    public string Id => "terminal-basic";
    public string Title => "Terminal Widget - Embedded Terminals Demo";
    public string Description => "Demonstrates multiple embedded diagnostic terminals with switching and restart";
