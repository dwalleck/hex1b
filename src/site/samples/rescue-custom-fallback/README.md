...
Extracted from `src/content/guide/widgets/rescue.md`, binding `customFallbackCode`.
...
Corrected JavaScript-style backtick interpolation in the legacy C# sample to C# interpolated strings. Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...).
