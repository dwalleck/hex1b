...
Extracted from `src/content/guide/widgets/navigator.md`, binding `TerminalDemo`.
...
Complete logic from src/Hex1b.Website/Examples/NavigatorExample.cs; removed ASP.NET/logger/base-class plumbing and used a normal console entry point. Preserved the documentation navigator ID although the backend calls it navigation.
