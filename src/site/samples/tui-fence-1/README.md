# Terminal User Interfaces — example 1
...
Extracted from `src/content/guide/tui.md`, binding `fence-1`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...). Added the Hex1b namespace import omitted by the surrounding guide.
