...
Extracted from `src/content/guide/widgets/align.md`, binding `demoCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...). Added the Hex1b.Widgets namespace import for Alignment.
