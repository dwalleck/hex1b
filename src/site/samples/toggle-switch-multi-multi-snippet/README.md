...
Extracted from `src/content/guide/widgets/toggle-switch.md`, binding `multiSnippet`.
Imported source: `src/content/guide/widgets/snippets/toggle-switch-multi.cs`.
