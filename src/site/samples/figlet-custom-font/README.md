...
Extracted from `src/content/guide/widgets/figlet.md`, binding `customFontSnippet`.
Imported source: `src/content/guide/widgets/snippets/figlet-custom-font.cs`.
