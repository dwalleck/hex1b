# Scroll Widget - Position Tracking
...
Extracted from `src/content/guide/widgets/scroll.md`, binding `trackingCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...). Renamed VScroll/HScroll to VScrollPanel/HScrollPanel in Hex1b 0.166.0.
