# Splitter Widget - Nested Splitters
...
Extracted from `src/content/guide/widgets/splitter.md`, binding `nestedCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced the removed Panel builder with VStack, preserving the same vertical child layout.
