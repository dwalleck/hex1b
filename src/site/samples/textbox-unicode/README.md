# TextBox Widget - Unicode Support
...
Extracted from `src/content/guide/widgets/textbox.md`, binding `unicodeCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Initialized UnicodeState.Input from the top-level constant instead of referencing a top-level local from inside a class.
