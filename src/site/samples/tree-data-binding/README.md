...
Extracted from `src/content/guide/widgets/tree.md`, binding `dataBoundCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Moved the FileNode record below top-level statements, as required by C#.
