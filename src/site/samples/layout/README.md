...
Extracted from `src/content/guide/layout.md`, binding `TerminalDemo`.
...
Complete logic from src/Hex1b.Website/Examples/LayoutExample.cs; removed ASP.NET/logger/base-class plumbing and used a normal console entry point.
