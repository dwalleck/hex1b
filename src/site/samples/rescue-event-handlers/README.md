...
Extracted from `src/content/guide/widgets/rescue.md`, binding `eventHandlersCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0.
