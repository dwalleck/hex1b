...
var sample = new ThemingExample();
var builder = sample.CreateWidgetBuilder();
await using var app = new Hex1bApp(_ => builder(), new Hex1bAppOptions
{
...
/// </summary>
internal class ThemingExample
{

    public string Id => "theming";
    public string Title => "Theming";
    public string Description => "Dynamic theme switching with live widget preview.";
    ...
    // Theme state shared by this application's widget builder and theme provider.
    private ThemingState? _currentSession;
    ...
    public Func<Hex1bTheme>? CreateThemeProvider()
    {
