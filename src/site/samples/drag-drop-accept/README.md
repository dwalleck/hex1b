...
Extracted from `src/content/guide/widgets/drag-drop.md`, binding `acceptCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Moved record declarations below top-level statements, as required by C#.
