...
Extracted from `src/content/guide/widgets/terminal.md`, binding `basicSnippet`.
Imported source: `src/content/guide/widgets/snippets/terminal-basic.cs`.
...
Requires bash on PATH; the embedded shell runs locally.
