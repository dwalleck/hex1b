...
Extracted from `src/content/guide/widgets/responsive.md`, binding `multipleSnippet`.
Imported source: `src/content/guide/widgets/snippets/responsive-multiple.cs`.
