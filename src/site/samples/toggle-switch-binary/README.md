...
Extracted from `src/content/guide/widgets/toggle-switch.md`, binding `binarySnippet`.
Imported source: `src/content/guide/widgets/snippets/toggle-switch-binary.cs`.
...
No API adaptations; the displayed program is copied unchanged.
