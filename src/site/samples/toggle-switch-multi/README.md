# ToggleSwitch Widget - Multiple Options
...
Extracted from `src/content/guide/widgets/toggle-switch.md`, binding `multiOptionCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...).
