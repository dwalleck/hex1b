# FigletText Widget - Color via EffectPanel
...
Extracted from `src/content/guide/widgets/figlet.md`, binding `colorCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Added the Hex1b.Theming namespace import for Hex1bColor.
