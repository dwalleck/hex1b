...
Extracted from `src/content/guide/widgets/table.md`, binding `selectionCode`.
...
Updated WithHex1bApp to the separate eager options/configure-app callbacks in Hex1b 0.166.0. Replaced Border's removed title argument with fluent .Title(...). Added Hex1b.Layout and Hex1b.Widgets namespace imports for SizeHint and Alignment.
